...
### [128. 最长连续序列](https://leetcode.cn/problems/longest-consecutive-sequence/)🔥（中等）4.09 4.14
...
### [215. 数组中的第K个最大元素](https://leetcode.cn/problems/kth-largest-element-in-an-array/)🔥（中等）4.09 4.14
...
注意：一开始要在res中存intervals[0]，同时遍历i从1开始
...
### [139. 单词拆分](https://leetcode.cn/problems/word-break/)🔥（中等）4.09
...
### [53. 最大子数组和](https://leetcode.cn/problems/maximum-subarray/)🔥（中等）4.14
...
注意：是从range（1， n）从1开始讨论，初始化时dp【0】已经设置好了
...
### [647. 回文子串](https://leetcode.cn/problems/palindromic-substrings/)（中等）4.09
...
- 情况三：下标：i 与 j相差大于1的时候，例如cabac，此时s[i]（s[0]）与s[j]（s[4]）已经相同了，我们看i到j区间是不是回文子串就看aba是不是回文就可以了，那么aba的区间就是 i+1 与 j-1区间，这个区间是不是回文就看dp[i + 1][j - 1]是否为true。



### [5. 最长回文子串](https://leetcode.cn/problems/longest-palindromic-substring/)🔥（中等）4.09 4.14
...
### [72. 编辑距离](https://leetcode.cn/problems/edit-distance/)🔥（中等）4.09 4.14
...
### [1143. 最长公共子序列](https://leetcode.cn/problems/longest-common-subsequence/)🔥（中等）4.09 4.14
...
### [206. 反转链表](https://leetcode.cn/problems/reverse-linked-list/)🔥（简单）4.09 4.14
...
### [108. 将有序数组转换为二叉搜索树](https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/)🔥（简单）4.09
...
### [236. 二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)🔥（中等）4.10
...
### [102. 二叉树的层序遍历](https://leetcode.cn/problems/binary-tree-level-order-traversal/)🔥（中等）4.14
...
### [104. 二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/)🔥（简单）4.14
